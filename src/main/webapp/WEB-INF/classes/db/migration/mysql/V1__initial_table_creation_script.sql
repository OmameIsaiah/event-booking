...
CREATE TABLE IF NOT EXISTS `event` (
  ...
  `last_modified` datetime(6) DEFAULT NULL,
  `uuid` varchar(255) NOT NULL,
  `available_attendees_count` int DEFAULT NULL,
...
INSERT INTO `event_booking_container`.`roles`(`id`,`date_created`,`last_modified`,`uuid`,`description`,`name`,`permissions`)
VALUES(0,'2024-06-5 10:30:10','2024-06-5 10:30:10',"18b56dc6-9813-440a-8c82-baf2eb10f264",'Role for administrators','ROLE_ADMIN','["CAN_VIEW_EVENTS","CAN_SEARCH_EVENTS","CAN_RESERVE_EVENT_TICKET","CAN_CREATE_EVENT","CAN_SEND_EVENT_NOTIFICATION","CAN_VIEW_USERS","CAN_ADD_ROLE","CAN_UPDATE_ROLE","CAN_DELETE_ROLE"]');
