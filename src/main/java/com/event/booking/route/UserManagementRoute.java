...
@Api(tags = "user management route", description = "Endpoints for searching, filtering and deleting users", consumes = "application/json", produces = "application/json", protocols = "https", value = "user management route")
