...
public class AppMessages {
    ...
    public static final String ACCOUNT_CREATION_SUCCESSFUL = "Awesome! Your account has been created successfully. An OTP has been sent to your registered email for verification and account activation.";
