...
public class AppMessages {
    ...
    public static final String NULL_CATEGORY = "Oops! Event category cannot be null, please check.";
    public static final String NULL_AVAILABLE_ATTENDEES_COUNT = "Oops! Available attendees count cannot be null, please check.";
    public static final String NULL_ATTENDEES_COUNT = "Oops! Attendees count cannot be null, please check.";
    ...
    public static final String NULL_RESERVATION_NO = "Oops! Reservation number cannot be null, please check.";
    ...
    public static final String EVENT_ALREADY_TAKEN = "Oops! An event with this name already exist in our record, kindly use another name.";
    ...
    public static final String EVENT_CREATED_SUCCESSFULLY = "Awesome! Your event has been created successfully.";
    public static final String EVENT_UPDATED_SUCCESSFULLY = "Awesome! Your event has been updated successfully.";
    public static final String EVENT_DELETED_SUCCESSFULLY = "Awesome! Your event has been deleted successfully.";
