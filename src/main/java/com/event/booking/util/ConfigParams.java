...
public class ConfigParams {
    public static final String APP_NAME = "event-booking";
    ...
    public static final String CONTACT_EMAIL = "omameazy@gmail.com";
    public static final String LICENSE = "Open Source";
    public static final String VERSION = "1.0.0";
    public static final String TOKEN_PREFIX = "Bearer";
    public static final String AUTHORIZATION_PASSED_IN = "header";
}
