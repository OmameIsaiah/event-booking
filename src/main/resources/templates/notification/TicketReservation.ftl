...
<g id="SVGRepo_iconCarrier"> <path d="M2 16C2 13.1716 2 11.7574 2.87868 10.8787C3.75736 10 5.17157 10 8 10H16C18.8284 10 20.2426 10 21.1213 10.8787C22 11.7574 22 13.1716 22 16C22 18.8284 22 20.2426 21.1213 21.1213C20.2426 22 18.8284 22 16 22H8C5.17157 22 3.75736 22 2.87868 21.1213C2 20.2426 2 18.8284 2 16Z" stroke="#ffffff" stroke-width="1.2"/> <circle cx="12" cy="16" r="2" stroke="#ffffff" stroke-width="1.2"/> <path d="M6 10V8C6 4.68629 8.68629 2 12 2C14.7958 2 17.1449 3.91216 17.811 6.5" stroke="#ffffff" stroke-width="1.2" stroke-linecap="round"/> </g>
        ...
        <span>Event reservation ticket</span>
    ...
    <div style="padding: 40px;">
        <div>
            ...
            <p style="font-size: 15px; margin-bottom: 10px; margin-top: 10px; line-height: 30px; color: #666666;">
                Your ticket reservation with Event Booking Ltd. was successful. Below are the details of your reservations:
            </p>
        </div>
        <div style="padding: 20px; color: #580abe; text-align: center; font-weight: 600; font-size: 20px;">Reservation Details
        </div>
        <div style="text-align: left; background-color: #f9f9f9; border-radius: 8px; color:black; margin-top: 10px; margin-bottom: 20px; justify-content: center; font-size: 18px; font-weight: 600; padding-top: 40px; padding-bottom: 40px; ">
            <ul>
                <li>
                    <b>Reservation No.:</b> ${reservationNo}</li>
                <li>
                    <b>Event Id:</b> ${eventId}</li>
                <li>
                    <b>Event Name:</b> ${eventName}</li>
                <li>
                    <b>Event Description:</b> ${eventDescription}</li>
                <li>
                    <b>Event Date:</b> ${eventDate}</li>
                <li>
    ...
    <div style="padding: 40px;">
        <div style="font-size: 15px; margin-bottom: 25px; margin-top: 25px; text-align: center; line-height: 30px; color: #666666;">
            If you did not reserve an event ticket with Event Booking Ltd., please disregard this email.
        </div>
