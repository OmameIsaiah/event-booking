    ...
    <div style="padding: 40px;">
        <div>
            ...
            <p style="font-size: 15px; margin-bottom: 10px; margin-top: 10px; line-height: 30px; color: #666666;">
                We hope this message finds you well. This is a gentle reminder regarding your ticket reservation for the upcoming event with
                Event Booking Ltd.
            </p>
        </div>
        <div style="padding: 20px; color: #580abe; text-align: center; font-weight: 600; font-size: 20px;">Event Details:
        </div>
        <div style="text-align: left; background-color: #f9f9f9; border-radius: 8px; color:black; margin-top: 10px; margin-bottom: 20px; justify-content: center; font-size: 18px; font-weight: 600; padding-top: 40px; padding-bottom: 40px; ">
            <ul>
                <li>
                    <b>Event Name:</b> ${eventName}</li>
                <li>
                    <b>Event Description:</b> ${eventDescription}</li>
                <li>
                    <b>Event Date and Time:</b> ${eventDate}</li>
                <li>
                    <b>Event Category:</b> ${eventCategory}</li>
                <li>
                    <b>Attendees Count:</b> ${attendeesCount}</li>
                <li>
                    <b>Status:</b> Reserved</li>
            </ul>
        </div>
    </div>
    <div style="padding: 40px;">
        <div style="font-size: 15px; margin-bottom: 10px; margin-top: -40px; text-align: left; line-height: 30px; color: #666666;">
            Your reservation is confirmed, and we look forward to welcoming you to the event. Should you have any questions or need further
            assistance, please don't hesitate to contact us.
            <p>
                Thank you for choosing Event Booking Ltd. We wish you an enjoyable and memorable experience at the event.
            </p>
        </div>
