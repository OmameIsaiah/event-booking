                              ...
                              " width="100%">
                                    ...
                                    <div style="text-align: right;">
                                        <a href="https://website.com" target="_blank">
                                            <img alt="" height="auto"
                                                 src="https://res.cloudinary.com/dxnwi4ob1/image/upload/v1680705731/winkeye6_y3rtkq.png"
                                                 style="border: 0;
                                                                    display: block;
                                                                    outline: none;
                                                                    text-decoration: none;
                              ...
                              " width="100%">
                                    ...
                                    ">
                                      ...
                                      ">
                                                            ...
                                                            <br/>
                                                            <p>
                                                                Thank you for registering with Musala Soft! To validate
                                                                your email and complete your
                                                                account creation, use the OTP below:
                                                            </p>
                                                            <p>
                                                                Your OTP is: <b>${otp}</b>
                                                            </p>
                                                            <p>
                                                                Kindly note that this OTP is temporary and will expire
                                                                in few minutes. If you did not create an account,
                                                        ...
                                                        <center>
                                                            <p style="margin-bottom: -10px; font-size: 0.8em;">
                                                                Address Line 1
                                                            </p>
                                                            <p style="margin-bottom: -10px; font-size: 0.8em;">
                                                                This email was sent to ${email}. Don't like these
                                                                emails?
                                                                <a href='https://www.musala.com/'>unsubscribe</a>
                                                                here.
                                                            </p>
                                                            <p style="margin-bottom: -10px; font-size: 0.8em;">
                                                                Designed by:
                                                                <a href='https://www.musala.com/'>Isaiah Omame
                                                                </a>.
                                                            </p>
                                                        </center>
